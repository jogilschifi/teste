...
from .models import Clubes, PalpitesPGL ,PalpitesFormula1, PontuacaoF1, PontuacaoTotalF1, ResultadosBrasileirao, OrdenacaoBrasileirao, Brasileirao, PontuacaoBrasileirao, PontuacaoTotalBrasileirao, CopadoBrasil, ResultadosCopadoBrasil
...
admin.site.register(PalpitesPGL)